...
export function PageHero({
  ...
  return (
    <header className="relative overflow-hidden border-b border-bone/10 pb-16 pt-16 md:pb-24 md:pt-24">
      ...
      <div className="mx-auto max-w-[1600px] px-4 md:px-8">
        ...
        {meta && (
          <dl className="mt-12 flex flex-wrap gap-x-12 gap-y-6 border-t border-bone/10 pt-8">
            {meta.map((m) => (
              <div key={m.k}>
